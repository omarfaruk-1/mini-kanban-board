export default function AuthShell({ title, subtitle, children, footer }) {
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-950 p-5">
      <div className="grid w-full max-w-5xl overflow-hidden rounded-3xl bg-white shadow-2xl md:grid-cols-[1fr_1.05fr]">
        <div className="hidden bg-slate-900 p-10 text-white md:flex md:flex-col md:justify-between">
          <div>
            ...
            <h2 className="mt-8 text-4xl font-bold leading-tight">
              Turn scattered work into clear progress.
            </h2>
            <p className="mt-4 max-w-sm text-sm leading-6 text-slate-300">
              Organize tasks, collaborate with your team and move work forward
              with a simple visual board.
            </p>
          </div>
